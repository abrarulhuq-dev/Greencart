...
const Addproduct = () => {
    ...
    return (
        <div className="no-srcollbar flex-1 h-[95vh] overflow-y-scroll flex flex-col justify-between">
            <form onSubmit={onSubmithandler} className="md:p-10 p-4 space-y-5 max-w-lg">
                ...
                <button disabled={loading} className={`px-8 py-2.5 bg-primary text-white font-medium rounded 
